...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_contact_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_contact_t qt_meta_stringdata_contact = {
    {
        QT_MOC_LITERAL(0, 7)   // "contact"
    },
    "contact"
};
...
Q_CONSTINIT static const uint qt_meta_data_contact[] = {
...
Q_CONSTINIT const QMetaObject contact::staticMetaObject = { {
    ...
    qt_meta_stringdata_contact.offsetsAndSizes,
    qt_meta_data_contact,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_contact_t,
        // Q_OBJECT / Q_GADGET
